...
class Users(db.Model, UserMixin):
    ...
    score = db.relationship(
        'GeneralScores', backref='general_scores', lazy=True)
...
class Components(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    wod_id = db.Column(db.Integer, db.ForeignKey(
        'workouts.id'))
    ...
    movements = db.relationship(
        'ComponentMovements', backref='movements', lazy=True)
    score = db.relationship(
        'GeneralScores', backref='component_scores', lazy=True)
...
class Movements(db.Model):
    ...
    components = db.relationship(
        'ComponentMovements', backref='components', lazy=True)
    movement_scores = db.relationship(
